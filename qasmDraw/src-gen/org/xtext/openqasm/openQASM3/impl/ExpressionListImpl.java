 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.openqasm.openQASM3.impl.ExpressionListImpl#getE1 <em>E1</em>}</li>
 *   <li>{@link org.xtext.openqasm.openQASM3.impl.ExpressionListImpl#getE2 <em>E2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpressionListImpl extends MinimalEObjectImpl.Container implements ExpressionList
{
  ...
  {
    return OpenQASM3Package.Literals.EXPRESSION_LIST;
  }
  ...
  public NotificationChain basicSetE1(Expression newE1, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OpenQASM3Package.EXPRESSION_LIST__E1, oldE1, newE1);
  ...
  public void setE1(Expression newE1)
  {
    if (newE1 != e1)
    {
      ...
      if (e1 != null)
        msgs = ((InternalEObject)e1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OpenQASM3Package.EXPRESSION_LIST__E1, null, msgs);
      if (newE1 != null)
        msgs = ((InternalEObject)newE1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OpenQASM3Package.EXPRESSION_LIST__E1, null, msgs);
      msgs = basicSetE1(newE1, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OpenQASM3Package.EXPRESSION_LIST__E1, newE1, newE1));
  }
  ...
  public EList<Expression> getE2()
  {
    if (e2 == null)
    {
      e2 = new EObjectContainmentEList<Expression>(Expression.class, this, OpenQASM3Package.EXPRESSION_LIST__E2);
    }
    return e2;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case OpenQASM3Package.EXPRESSION_LIST__E1:
        return basicSetE1(null, msgs);
      case OpenQASM3Package.EXPRESSION_LIST__E2:
